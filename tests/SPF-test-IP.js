...
function ipv6_parse() {
	...
	Assert.deepEqual(
		...
		[32,1,13,184,133,163,0,0,0,0,138,46,3,112,115,52],
		"ipv6_parse groups of zeroes 01"
	);
	Assert.deepEqual(
		(new SPF._IP("::0db8:85a3:0000:0000:8a2e:0370:7334"))._buffer,
		[0,0,13,184,133,163,0,0,0,0,138,46,3,112,115,52],
		"ipv6_parse groups of zeroes 02"
	);
	Assert.deepEqual(
		(new SPF._IP("2001:0db8:85a3:0000:0000:8a2e:0370::"))._buffer,
		[32,1,13,184,133,163,0,0,0,0,138,46,3,112,0,0],
		"ipv6_parse groups of zeroes 03"
	);
	Assert.deepEqual(
		(new SPF._IP("::"))._buffer,
