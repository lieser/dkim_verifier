...
describe("ARH Parser [unittest]", function () {
	describe("RFC 7601 Appendix B Example", function () {
		it("B.2.  Nearly Trivial Case; Service Provided, but No Authentication Done", async function () {
			const res = await ArhParser.parse(
		...
		it("B.3.  Service Provided, Authentication Done", async function () {
			const res = await ArhParser.parse(
		...
		it("B.4.  Service Provided, Several Authentications Done, Single MTA", async function () {
			let res = await ArhParser.parse(
				"Authentication-Results: example.com;\r\n" +
		...
		it("B.5.  Service Provided, Several Authentications Done, Different MTAs", async function () {
			let res = await ArhParser.parse(
				"Authentication-Results: example.com;\r\n" +
		...
		it("B.6.  Service Provided, Multi-tiered Authentication Done", async function () {
			let res = await ArhParser.parse(
				'Authentication-Results: example.com;\r\n' +
		...
		it("B.7.  Comment-Heavy Example", async function () {
			const res = await ArhParser.parse(
