...
DKIM_STRINGS.DKIM_INTERNALERROR_NAME			= "Internal error";
DKIM_STRINGS.DKIM_INTERNALERROR_DEFAULT			= "error";
DKIM_STRINGS.DKIM_INTERNALERROR_INCORRECT_EMAIL_FORMAT	= "E-mail is not correctly formatted";
// DKIM_INTERNALERROR - DNS
DKIM_STRINGS.DKIM_DNSERROR_SERVER_ERROR			= "Error connecting to DNS server";
